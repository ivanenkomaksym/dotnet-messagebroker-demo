...
kubectl apply -f ocelot_configmap.yaml
...
kubectl apply -f ocelotapigateway_service.yaml
...
Start-Process -FilePath "cmd" -ArgumentList "/c minikube service ocelotapigateway-service" -WorkingDirectory ".\"
